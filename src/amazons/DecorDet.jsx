...
{/* Top & NavBar */}
    ...
    <Container fluid>
        ...
        <div className="image-gallery custom-image-gallery">
         ...
         width={100} />
            ...
            <img src={require('../images/st1.png')} width="180px"  /> 
            ...
            <p> M.R.P. <del> 2,999 </del> <br></br>
            Inclusive of all taxes <br></br>
            EMI starts at ₹103 per month.<span className="text-danger"> EMI OPTIONS </span> </p>
            <hr></hr>
            <img src={require('../images/off.png')} width="100%"  /> 
            <hr></hr>
            ...
            <ul>
                <li> Looking for a clock that's more than just a timekeeper? This handcrafted wall clock is a conversation starter and a statement piece for any room. It's the perfect way to add a touch of industrial chic to your space<br></br> </li>
            ...
            <Row>
              <Col xs={6}>
              <img src={require('../images/st2.png')} width="100%"  /> 
              </Col>
            ...
            <p> Sold by
            <span style={{marginLeft:"25px"}}> RIZIK STORE </span> </p>

            <h6> Add a Protection Plan: </h6>
            <p>1 Year Fire Protection Plan <br></br>
             For <MdCurrencyRupee /> 99.00 </p> 
        ...
        <img src={require('../images/st5.png')} width="100%" /> 
        </Row>
        <hr></hr>
    ...
    With the Rizik Store Handcrafted Multicolor Wall Clock, you're not just buying a timepiece; you're investing in a piece of artistry that will transform your living space and leave a lasting impression. Immerse yourself in the world of fine craftsmanship and bring home this exceptional w
    </p>
    </Container>
    <hr></hr>
