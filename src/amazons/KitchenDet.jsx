...
<Col xs={6} md={2} lg={1} className="custom-class text-white bg-dark text-center">
  ...
  <Row>
    ...
    <Col xs={12} md={6} lg={4} className="mt-5">
      ...
      <img src={require('../images/kc1.png')} className="img-fluid" alt="Dish Rack" />
      <hr />
      <h5 className="text-danger">-39% <span style={{ marginLeft: "10px", fontSize: "30px", color: "black" }}><MdCurrencyRupee /> 369</span></h5>
      <p>M.R.P. <del>699</del> <br /> Inclusive of all taxes <br /> EMI starts at ₹128 per month.<span className="text-danger"> EMI OPTIONS</span></p>
      <hr />
      <img src={require('../images/kc2.png')} className="img-fluid" alt="Drying Tray" />
      <hr />
      ...
      <ul>
        ...
        <li>Consists of a storage basket for storing and arranging just washed utensils. Major space saver in kitchen</li>
        <li>Package Included: 1 x Dish Rack, 1 x Draining Tray, 1 x Knife and Fork Holder</li>
      </ul>

      <h4>Customer ratings by feature</h4>
      <img src={require('../images/kc3.png')} className="img-fluid" alt="Ratings" />
    </Col>

    <Col xs={12} md={6} lg={2} className="card p-3">
      <p className="text-success"><MdCurrencyRupee /> <b>369.00</b></p>
      <h6>FREE delivery Tuesday, 13 August on orders dispatched by Amazon over ₹499. <br /><span className="text-warning">Details</span></h6>
      <h6>Or fastest delivery Tomorrow, 9 August. Order within 15 hrs 50 mins. <br /><span className="text-warning">Details</span></h6>
      ...
      <p>Sold by <span style={{ marginLeft: "25px" }}>RetailEZ Pvt Ltd</span></p>
      Quantity: <input type="number" min="1" style={{ width: "30%" }} />
      <br />
  ...
  <Row className="p-3">
    ...
    <img src={require('../images/kc5.png')} className="img-fluid" alt="Recommendations" />
  </Row>
  <hr />
  ...
  <Container fluid style={{ paddingRight: "20px", paddingLeft: "20px" }}>
    ...
    <Row className="mt-2 bg-white text-dark p-4">
      <Carousel controls={true} indicators={true}>
        <Carousel.Item>
          <img className="d-block w-100 img-fluid" src={require('../images/kc6.png')} alt="Carousel item" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 img-fluid" src={require('../images/kc7.png')} alt="Carousel item" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 img-fluid" src={require('../images/kc8.png')} alt="Carousel item" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 img-fluid" src={require('../images/kc9.png')} alt="Carousel item" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 img-fluid" src={require('../images/kc10.png')} alt="Carousel item" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 img-fluid" src={require('../images/kc11.png')} alt="Carousel item" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100 img-fluid" src={require('../images/kc12.png')} alt="Carousel item" />
        </Carousel.Item>
      </Carousel>
    </Row>
  </Container>
  ...
  <Container>
    <Row>
      ...
      <br />
      <input type="text" placeholder="Search In Reviews & Q And Ans" style={{ width: "50%" }} />
    </Row>
  </Container>
  <br />
  <hr />
  ...
  <Row>
    <Col xs={12} className="text-center">
      <img src={require('../images/kc13.png')} className="img-fluid" alt="Advertisement" />
    </Col>
  </Row>
  <hr />
  ...
  <Row className="bg-white p-3">
    <img src={require('../images/kc14.png')} className="img-fluid" alt="Inspired" />
  </Row>
  <hr />
